...
function ManyHellos(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    ...
    this.manyHellos_prepare = function (prepare_params, _callback, _errorCallback, json_rpc_context) {
        if (self.service_version) {
            if (!json_rpc_context)
                json_rpc_context = {};
            json_rpc_context['service_ver'] = self.service_version;
        ...
        var async_job_check_time_ms = self.async_job_check_time_ms;
        self._manyHellos_prepare_submit(prepare_params, function(job_id) {
            var _checkCallback = null;
            _checkCallback = function(job_state) {
                if (job_state.finished != 0) {
                    if (!job_state.hasOwnProperty('result'))
    ...
    this._manyHellos_prepare_submit = function (prepare_params, _callback, _errorCallback, json_rpc_context) {
        if (typeof prepare_params === 'function')
            throw 'Argument prepare_params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        if (_errorCallback && typeof _errorCallback !== 'function')
            throw 'Argument _errorCallback must be a function if defined';
        ...
        return json_call_ajax(_url, "ManyHellos._manyHellos_prepare_submit", 
            [prepare_params], 1, _callback, _errorCallback, json_rpc_context);
    };
    ...
    this.manyHellos_collect = function (collect_params, _callback, _errorCallback, json_rpc_context) {
        if (self.service_version) {
            if (!json_rpc_context)
                json_rpc_context = {};
            json_rpc_context['service_ver'] = self.service_version;
        ...
        var async_job_check_time_ms = self.async_job_check_time_ms;
        self._manyHellos_collect_submit(collect_params, function(job_id) {
            var _checkCallback = null;
            _checkCallback = function(job_state) {
                if (job_state.finished != 0) {
                    if (!job_state.hasOwnProperty('result'))
    ...
    this._manyHellos_collect_submit = function (collect_params, _callback, _errorCallback, json_rpc_context) {
        if (typeof collect_params === 'function')
            throw 'Argument collect_params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        if (_errorCallback && typeof _errorCallback !== 'function')
            throw 'Argument _errorCallback must be a function if defined';
        ...
        return json_call_ajax(_url, "ManyHellos._manyHellos_collect_submit", 
            [collect_params], 1, _callback, _errorCallback, json_rpc_context);
    };
