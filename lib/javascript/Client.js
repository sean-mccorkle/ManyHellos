...
function ManyHellos(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    ...
    var _auth_cb = auth_cb;
     ...
     this.manyHellos = function (input_params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ManyHellos.manyHellos",
            [input_params], 1, _callback, _errorCallback);
    };
 
     this.manyHellos_prepare = function (input_params, _callback, _errorCallback) {
        if (typeof input_params === 'function')
            throw 'Argument input_params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "ManyHellos.manyHellos_prepare",
            [input_params], 1, _callback, _errorCallback);
    };
 
     this.manyHellos_runEach = function (task, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "ManyHellos.manyHellos_runEach",
            [task], 1, _callback, _errorCallback);
    };
 
     this.manyHellos_collect = function (input_params, _callback, _errorCallback) {
        if (typeof input_params === 'function')
            throw 'Argument input_params can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "ManyHellos.manyHellos_collect",
            [input_params], 1, _callback, _errorCallback);
    };
 
     this.hi = function (_callback, _errorCallback) {
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        if (_errorCallback && typeof _errorCallback !== 'function')
            throw 'Argument _errorCallback must be a function if defined';
        ...
        return json_call_ajax(_url, "ManyHellos.hi",
